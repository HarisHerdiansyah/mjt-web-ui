    ...
    <div className="space-y-2 text-sm">
      <div
        className={clsx(
          ...
          {
            "border-amber-400 bg-amber-100": sch.trafficJam,
            "border-green-500 bg-green-100": !sch.trafficJam,
          },
        )}
      >
      ...
      <div className="px-2 py-1 rounded-lg border-3 border-blue-500 bg-blue-100 flex items-center gap-2">
        {sch.rainLevel === 0 ? (
...
export default function TripCard() {
  ...
  return schedules.map((sch: ExtractedSchedule, i) => (
    <div
